...
elseif ($action=='act_edit_friend_link')
{
	...
	{
		sys_message('请填写友情链接名称',$referer_url,2);
	}

	if (empty($module_content))
	{
		sys_message('请填写友情链接URL',$referer_url,2);
	}
	...
	{
		sys_message('编辑友情链接失败，请重新返回添加',$referer_url,2);
	}
}
...
elseif ($action=='act_add_friend_link')
{
	...
	{
		sys_message('添加失败，请重新返回添加',$referer_url,2);
	}
}
