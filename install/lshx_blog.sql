...
INSERT INTO fb_config (`key`,`value` ) VALUES ( 'blog_desc','蓝色航线博客系统是基于PHP+MySQL的开源博客系统。'),('blog_keyword','蓝色航线博客系统'),('blog_name','蓝色航线博客系统'),('cache_lifetime','24'),('comment_safe','0'),('comment_sort','1'),('domain','https://blueblog.lansehangxian.com/'),('is_cache','0'),('is_reg','0'),('notice','博客通知信息'),('open_comment','0'),('pager_size','6'),('page_size','10'),('rewrite','0'),('template_name','default'),('tj','');
...
INSERT INTO `lshx_link` (`link_id`, `title`, `desc`, `url`, `sort`) VALUES
(1, '蓝色航线博客系统', '蓝色航线博客系统官方网站', 'https://blueblog.lansehangxian.com', 1),
(2, '蓝色航线-腾讯云代理', '腾讯云代理', 'https://www.lansehangxian.com/', 2),
(3, '海平线-阿里云代理', '阿里云代理', 'https://www.haipingxian.com/', 3),
(4, '华为云代理', '', 'https://www.hwydl.com/', 4),
(5, '腾讯企业邮箱代理', '腾讯企业邮箱代理', 'https://www.txyxdl.cn/', 5),
(7, '企业qq代理', '企业qq代理', 'https://www.qiye-qq.cn/', 9),
(8, '腾讯云代理', '腾讯云代理', 'https://www.tengxunyundaili.cn/', 8);
...
INSERT INTO fb_plugins (`plugin_id`,`plugin_name`,`plugin_desc`,`author`,`version`,`plugin_point`,`cp_type`,`add_time` ) VALUES ( 'new_article','最新文章','在边栏显示最新文章','p','1.0','1','0','1302985854');
